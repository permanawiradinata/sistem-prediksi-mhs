            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="wrap-input100 validate-input">
                        ...
                        <span class="focus-input100" data-placeholder="&#xf159;"></span>
                        @error('email')
                        <small class="text-danger">{{ $message == 'The email field is required.' ? 'Kolom email tidak boleh kosong' : $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="wrap-input100 validate-input">
                        ...
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                        @error('password')
                        <small class="text-danger">{{ $message == 'The password field is required.' ? 'Kolom repeat password tidak boleh kosong' : $message }}</small>
                        @enderror
                    </div>
