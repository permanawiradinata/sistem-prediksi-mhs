        ...
        <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('data-mahasiswa')}}">
                            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Halaman Data Matahasiswa</li>
                        </ol>
                        <h6 class="font-weight-bolder text-white mb-0">Data Mahasiswa</h6>
                    </nav>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <!-- Form Upload dan Tombol Import (kanan) -->
                                ...
                                <!-- <form action="{{ route('preview-import') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="file" name="file" required accept=".xlsx,.xls,.csv">
                                    <button type="submit" class="btn btn-warning">Preview Data</button>
                                </form> -->
                                    ...
                                    <table class="table align-items-center mb-0" id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <!-- <a href="" class="btn btn-warning btn-sm">Prediksi</a><br> -->


                                                    <a class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalHapus{{ $d->id}}">Hapus</a><br>

                                                    <a href="{{ route('update-data', $d->id)}}" class="btn btn-info btn-sm">Edit</a><br>

                                                    <!-- Modal Konfirmasi -->
                                                    <div class="modal fade" id="modalHapus{{ $d->id }}" tabindex="-1" aria-labelledby="hapusModalLabel{{ $d->id }}" aria-hidden="true">
