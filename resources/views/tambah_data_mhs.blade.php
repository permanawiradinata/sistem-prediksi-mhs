...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/img/pnb-logo.png">
    <title>
    ...
    <link href="assets/dashboard/assets/css/nucleo-svg.css" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="assets/dashboard/assets/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" />
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link active" href="{{ route('tambah-data')}}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Halaman Tambah Data Mahasiswa</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Tambah Data Mahasiswa</h6>
                </nav>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('proses-tambah-data')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control" name="status_bekerja">
                                                ...
                                                <option value="tidak" {{ old('status_bekerja') == 'tidak' ? 'selected' : '' }}>Tidak</option>
                                            </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control" name="status_menikah">
                                            ...
                                            <option value="belum" {{ old('status_menikah') == 'belum' ? 'selected' : '' }}>Belum</option>
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="ips1" value="{{ old('ips1') }}" name="ips1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="ips2" value=" {{ old('ips2') }}" name="ips2">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="ips3" value=" {{ old('ips3') }}" name="ips3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="ips4" value="{{ old('ips4') }} " name="ips4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="ipk" value="{{ old('ipk') }} " name="ipk">
                                        @error('ipk') <div class="text-danger"><small>{{ $message }}</small></div> @enderror
                                    </div>
                                </div>

                                <button type="submit" class="btn btn-success btn-sm ms-auto">Tambah Data</button>
                            </form>
                            <!-- <script>
