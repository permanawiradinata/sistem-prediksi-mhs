    ...
    <body class="g-sidenav-show   bg-gray-100">
        ...
        <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('data-prediksi-mhs')}}">
                            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-body pt-3">
                                ...
                                <h5 class="mb-3"><small><b>Dataset</b></small></h5>
                                ...
                                <!-- <form action="{{ route('prediksi.massal') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-primary btn-sm">Prediksi Semua Data</button>
                                </form>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    <button class="btn btn-primary btn-prediksi btn-sm"
                                                        data-id="{{ $d->id }}">Prediksi</button>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-body pt-3">
                                <!-- <a><small>Dibawah ini anda dapat melakukan Tambah Data Monitoring dan Download Data Monitoring secara keseluruhan</small></a><br> -->
                                <h5 class="mb-3"><small><b>Tabel Data Prediksi</b></small></h5>
        ...
        <!-- Modal Bootstrap -->
        <div class="modal fade" id="modalPrediksi" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Hasil Prediksi Kelulusan</h5>
        ...
        <script>
            $(document).on('click', '.btn-prediksi', function() {
                const id = $(this).data('id');

                $.ajax({
                    url: "{{ route('mahasiswa.prediksi2') }}",
                    type: "POST",
                    data: {
                        id: id,
                        _token: '{{ csrf_token() }}'
                    ...
                    <tr><th>Status Bekerja</th><td>${data.status_bekerja}</td></tr>
                    <tr><th>Status Menikah</th><td>${data.status_menikah}</td></tr>
                    <tr><th>Umur</th><td>${data.umur}</td></tr>
                    <tr><th>IPS 1</th><td>${data.ips1}</td></tr>
                    <tr><th>IPS 2</th><td>${data.ips2}</td></tr>
                    <tr><th>IPS 3</th><td>${data.ips3}</td></tr>
                    <tr><th>IPS 4</th><td>${data.ips4}</td></tr>
                    <tr><th>IPK</th><td>${parseFloat(data.ipk).toFixed(2)}</td></tr>
                    <tr class="table-success"><th>Status Kelulusan</th><td><strong>${data.status_kelulusan}</strong></td></tr>
                `;

                        $('#tabel-hasil').html(html);
